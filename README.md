This template uses relative symbolic links to minimize the duplication of template files. The unique templates could be found in the following directories:
